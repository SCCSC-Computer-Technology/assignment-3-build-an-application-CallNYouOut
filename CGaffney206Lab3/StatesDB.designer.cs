...
namespace CGaffney206Lab3
{
	...
	public partial class State : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _Top_3_Largest_Cities;
    ...
    partial void OnTop_3_Largest_CitiesChanging(string value);
    partial void OnTop_3_Largest_CitiesChanged();
    ...
    partial void OnPercentage_of_Computer_Related_Jobs_OfferedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Top 3 Largest Cities]", Storage="_Top_3_Largest_Cities", DbType="NVarChar(MAX)")]
		public string Top_3_Largest_Cities
		{
			get
			{
				return this._Top_3_Largest_Cities;
			}
			set
			{
				if ((this._Top_3_Largest_Cities != value))
				{
					this.OnTop_3_Largest_CitiesChanging(value);
					this.SendPropertyChanging();
					this._Top_3_Largest_Cities = value;
					this.SendPropertyChanged("Top_3_Largest_Cities");
					this.OnTop_3_Largest_CitiesChanged();
				}
			}
		}
